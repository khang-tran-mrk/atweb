...
public class RSAUtil {
	...
	public static String keyToString(PublicKey publicKey) {
		...
		String pubkeyStr = Base64.getEncoder().encodeToString(byte_pubkey);
		return pubkeyStr;
	}
	...
	public static String keyToString(PrivateKey privateKey) {
		...
		// converting byte to String
		String privkeyStr = Base64.getEncoder().encodeToString(byte_pubkey);
		return privkeyStr;
	}

//    public static void main(String[] args) throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException {
//        try {
//            PrivateKey privateKey = KeyReader.getPrivateKeyFromFile("RSA/privateKey");
//            PublicKey publicKey = KeyReader.getPublicKeyFromFile("RSA/publicKey");
//            String encryptedString = Base64.getEncoder().encodeToString(encrypt("Dhiraj is the author", keyToString(publicKey)));
//            System.out.println(encryptedString);
//            String decryptedString = RSAUtil.decrypt(encryptedString, keyToString(privateKey));
